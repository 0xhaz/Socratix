        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-10">
            ...
            <div className="col-span-2 space-y-4">
              <h3 className="text-2xl font-bold text-primary">Socratix</h3>
              <p className="text-sm text-muted-foreground max-w-xs">
                A memory-enabled Socratic tutor that teaches students to reason —
                and keeps instructors in control of the curriculum.
              </p>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                {["Privacy Policy", "Terms", "Cookies", "GDPR", "License"].map(
                  item => (
                    <li key={item}>
                      <a
                        href="#"
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div className="max-w-sm">
                ...
                <p className="text-sm text-muted-foreground">
                  Get the latest updates and news from Socratix.
                </p>
              </div>
          ...
          <div className="border-t border-border mt-8 pt-6 text-center">
            <p className="text-xs text-muted-foreground">
              © 2026 Socratix. All rights reserved.
            </p>
          </div>
        </div>
      </div>

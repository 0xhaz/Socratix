...
export const Hero = () => {
  ...
  const primaryButtonText = isCreator
    ? "Create New Course"
        ...
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6 animate-fade-in leading-tight">
            <span className="block text-foreground">
              {isCreator ? "You Own the Syllabus" : "Learn by Questioning"}
            </span>
          ...
          >
            {isCreator
              ? "Bring your own curriculum. Socratix generates the practice and tutors your students Socratically — within the method you teach — then shows you exactly where their misconceptions live. Nothing reaches a student until you approve it."
              : "A Socratic AI tutor that never just hands you the answer. It works out why you're stuck, guides you with questions until it clicks, remembers what you've mastered across sessions, and checks you can solve the next problem on your own."}
          </p>
          ...
          {isCreator && (
            ...
            >
              <p>
                ✨ Ready to create your next course? Get started in minutes!
              </p>
            </div>
          )}
        </div>

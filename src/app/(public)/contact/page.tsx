...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const emailSubject = encodeURIComponent(subject || "Socratix LMS Contact");
    ...
    window.open(
      `mailto:hazrienne@gmail.com?subject=${emailSubject}&body=${emailBody}`,
    );
  ...
  const quickActions = [
    ...
    {
      label: "Direct Email",
      link: "mailto:hazrienne@gmail.com",
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Email me directly at hazrienne@gmail.com. I typically respond within 24 hours.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-muted/20 to-transparent">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10 max-w-4xl">
          <Badge
            variant="outline"
            className="mb-6 px-6 py-2 border-primary/20 bg-background/80 backdrop-blur-sm"
          >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Have questions about Socratix LMS? I&apos;m here to help you succeed
            ...
            <div className="space-y-8">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-muted-foreground text-lg leading-relaxed">
                  ...
                  , creator of Socratix LMS. Ready to help with any questions or
                  support you need.
                </p>
              </div>
                ...
                <Card className="group hover:shadow-lg transition-all duration-300 border-l-4 border-l-primary">
                  <CardContent className="flex items-center gap-4 py-1 px-6">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:maityp394@gmail.com"
      ...
      <section className="py-20 bg-background relative">
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Common questions about Socratix LMS. Need more help? Contact me
              directly.
            </p>
          </div>
              ...
              <div className="space-y-6 w-full">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    I&apos;m here to help you make the most of Socratix LMS.
                  </p>
                </div>
                <Button asChild size="lg" className="px-8">
                  <a href="mailto:hazrienne@gmail.com?subject=Socratix LMS Question">
